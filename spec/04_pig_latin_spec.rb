...
describe "#translate" do
  ...
  it "retains capitalization" do
    s = translate("The Sound and the Fury")
    expect(s).to eq("Ethay Oundsay anday ethay Uryfay")
  end 
  # * retain the punctuation from the original phrase
  # checks apostrophes, but will fail on double/single quotes
  it "retains punctuation" do 
    s = translate("How was it? Let's see: 'Twas Quite good!")
    expect(s).to eq("Owhay asway itay? Et'slay eesay: as'Tway Itequay oodgay!")
  end
